...
\begin{itemize}
	...
	\\
	\headerrow
		{\emph{Software Engineer, CRM}}
		{\emph{June 2015-Present}}
	\vspace{-1.5em}
	\begin{itemize*}
		\item Gained experience with Ruby on Rails and Javascript
		\item Built real-time communication with Cisco Phone System to live update UI
		\item Refactored the whole Frontend to use React
