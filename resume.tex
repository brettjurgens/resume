...
\begin{itemize}
	...
	\begin{itemize*}
		...
		reliability
		\item Worked on the website front-end and the user acquisition system
	\end{itemize*}
...
\begin{itemize}
	...
	\begin{itemize*}
		...
		Pi Kappa Phi Fraternity, ACM, IEEE
            \vspace{.5em}
		...
		User Interface Design, Programming Studio, Database Systems, Introduction 
		to Bioinformatics, Programming Languages and Compilers, Embedded Systems, 
		Senior Project
	\end{itemize*}
